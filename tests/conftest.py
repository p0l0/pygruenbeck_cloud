...
@pytest.fixture()
def login_step_1_response_headers() -> CIMultiDict:
    ...
    return CIMultiDict(
        [
            ...
            ("Allow", "HEAD"),
            ("Allow", "POST"),
            ("Date", "Thu, 11 Jan 2024 20:31:23 GMT"),
        ]
    )


@pytest.fixture()
def login_step_2_response():
...
@pytest.fixture()
def login_step_2_response_headers() -> CIMultiDict:
...
@pytest.fixture()
def login_step_3_response_headers() -> CIMultiDict:
    ...
    return CIMultiDict(
        [
            ...
            (
                "Set-Cookie",
                "x-ms-cpim-sso:gruenbeckb2c.onmicrosoft.com_0=m1.Xv8OXEZ05e3qLcbX.4W6C0e4+p3bY3AaT1Fwf6A==.0.; domain=gruenbeckb2c.b2clogin.com; path=/; SameSite=None; secure; HttpOnly",
            ),
            (
                "Set-Cookie",
                "x-ms-cpim-cache|2l3io3ed2eop2vq5tcrnuw_0=; domain=gruenbeckb2c.b2clogin.com; expires=Sat, 11-Jan-2014 20:31:24 GMT; path=/; SameSite=None; secure; HttpOnly",
            ),
            (
                "Set-Cookie",
                "x-ms-cpim-trans=; domain=gruenbeckb2c.b2clogin.com; expires=Sat, 11-Jan-2014 20:31:24 GMT; path=/; SameSite=None; secure; HttpOnly",
            ),
            ("Allow", "OPTIONS"),
            ("Allow", "TRACE"),
            ("Allow", "GET"),
            ("Allow", "HEAD"),
            ("Allow", "POST"),
            ("Date", "Thu, 11 Jan 2024 20:31:24 GMT"),
        ]
    )


@pytest.fixture()
def login_step_4_response():
...
@pytest.fixture()
def login_step_4_response_headers() -> CIMultiDict:
...
@pytest.fixture()
def refresh_token_response_headers() -> CIMultiDict:
...
def enter_sd_response_headers() -> CIMultiDict:
    ...
    return CIMultiDict(
        [
            ("Date", "Thu, 11 Jan 2024 20:44:37 GMT"),
            ("Strict-Transport-Security", "max-age=31536000; includeSubDomains"),
            ("Request-Context", "appId=cid-v1:9bf1e130-ec63-42ac-b6a7-7ce1131e9176"),
        ]
    )
...
def refresh_sd_response_headers() -> CIMultiDict:
    ...
    return CIMultiDict(
        [
            ("Date", "Thu, 11 Jan 2024 20:44:38 GMT"),
            ("Strict-Transport-Security", "max-age=31536000; includeSubDomains"),
            ("Request-Context", "appId=cid-v1:9bf1e130-ec63-42ac-b6a7-7ce1131e9176"),
        ]
    )
